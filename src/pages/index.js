...
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>Медицинская Сервисная Компания. Экстренная госпитализация. +7 (499) 719 81 00, 24/7</title>
                ...
                <meta property="og:title" content="Медицинская Сервисная Компания. Экстренная госпитализация. +7 (499) 719 81 00, 24/7" />
